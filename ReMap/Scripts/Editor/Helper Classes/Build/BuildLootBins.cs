...
namespace Build
{
    ...
    {
        public static string BuildLootBinObjects( GameObject[] objectData, BuildType buildType )
        {
            string code = "";
            ...
            foreach ( GameObject obj in objectData )
            {
                ...
                switch ( buildType )
                {
                    ...
                    case BuildType.EntFile:
                        ...
                        code += $"\"script_name\" \"survival_lootbin\"\n";
                        code += $"\"model\" \"mdl/props/loot_bin/loot_bin_01_animated.rmdl\"\n";
