...
public class FirstTimeWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label(Resources.Load<Texture2D>("CustomEditor/Welcome") as Texture2D, GUILayout.Width(400), GUILayout.Height(100));
