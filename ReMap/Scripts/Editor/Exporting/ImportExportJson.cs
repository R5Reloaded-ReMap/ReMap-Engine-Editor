...
public class ImportExportJson
{
    ...
    public static async void ImportJson()
    {
        ...
        SortListByKey( jsonData.Props, x => x.PathString );
        SortListByKey( jsonData.Ziplines, x => x.PathString );
        SortListByKey( jsonData.LinkedZiplines, x => x.PathString );
        SortListByKey( jsonData.VerticalZipLines, x => x.PathString );
        SortListByKey( jsonData.NonVerticalZipLines, x => x.PathString );
        SortListByKey( jsonData.SingleDoors, x => x.PathString );
        SortListByKey( jsonData.DoubleDoors, x => x.PathString );
        SortListByKey( jsonData.HorzDoors, x => x.PathString );
        SortListByKey( jsonData.VerticalDoors, x => x.PathString );
        SortListByKey( jsonData.Buttons, x => x.PathString );
        SortListByKey( jsonData.Jumppads, x => x.PathString );
        SortListByKey( jsonData.LootBins, x => x.PathString );
        SortListByKey( jsonData.WeaponRacks, x => x.PathString );
        SortListByKey( jsonData.Triggers, x => x.PathString );
        SortListByKey( jsonData.BubbleShields, x => x.PathString );
        SortListByKey( jsonData.SpawnPoints, x => x.PathString );
        SortListByKey( jsonData.TextInfoPanels, x => x.PathString );
        SortListByKey( jsonData.FuncWindowHints, x => x.PathString );
        SortListByKey( jsonData.Sounds, x => x.PathString );
        ...
        else
        {
            switch ( classData )
            {
                ...
                case VerticalZipLineClassData data: // Vertical Ziplines
                    ...
                    {
                        UnityEngine.Object loadedPrefabResourcePanel = FindPrefabFromName( "mdl#" + panelData.Model );
    ...
    private static GameObject ProcessImportClassData< T >( T objData, string objName, ObjectType objectType, int i, int j, int objectsCount ) where T : GlobalClassData
    {
        ...
        UnityEngine.Object loadedPrefabResource = FindPrefabFromName( objName );
