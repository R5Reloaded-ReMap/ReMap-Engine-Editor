...
[AddComponentMenu("ReMap/Non-Vertical Zipline", 0)]
public class DrawNonVerticalZipline : MonoBehaviour
{
    ...
    public Transform helperPlacement_start;
    public Transform helperPlacement_end;
    ...
    public bool ShowArmOffsetStart = false;
    public bool ShowArmOffsetEnd = false;
