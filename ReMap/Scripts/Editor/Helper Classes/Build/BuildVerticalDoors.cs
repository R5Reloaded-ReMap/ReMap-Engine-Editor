        ...
        public static async Task< StringBuilder > BuildVerticalDoorObjects( GameObject[] objectData, BuildType buildType )
        {
            ...
            foreach ( GameObject obj in objectData )
            {
                ...
                switch ( buildType )
                {
                    ...
                    case BuildType.LiveMap:
                        CodeViews.LiveMap.AddToGameQueue($"script MapEditor_SpawnDoor( {Helper.BuildOrigin( obj, false, true )}, {Helper.BuildAngles(obj)}, eMapEditorDoorType.Vertical, false, {Helper.BoolToLower( script.AppearOpen )}, true )");
                    break;
                }
            }
