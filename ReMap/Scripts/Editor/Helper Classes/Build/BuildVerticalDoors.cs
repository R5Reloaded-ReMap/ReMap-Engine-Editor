...
namespace Build
{
    ...
    {
        public static string BuildVerticalDoorObjects( GameObject[] objectData, BuildType buildType )
        {
            string code = "";
            ...
            foreach ( GameObject obj in objectData )
            {
                ...
                {
                    case BuildType.Script:
                        code += $"    MapEditor_SpawnDoor( {Helper.BuildOrigin(obj) + Helper.ShouldAddStartingOrg()}, {Helper.BuildAngles(obj)}, eMapEditorDoorType.Vertical )";
                        PageBreak( ref code );
                        break;
                    ...
                    case BuildType.EntFile:
                            ...
                            code += $"\"model\" \"mdl/door/door_canyonlands_large_01_animated.rmdl\"\n";
