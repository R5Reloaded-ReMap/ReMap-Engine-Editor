...
public class UnityInfo
{
    ...
    {
        return selection ? Selection.gameObjects : Object.FindObjectsOfType< GameObject >();
    }
    ...
    public static int GetAllCount()
    {
        ...
        foreach ( var go in GetAllGameObjectInScene() )
    ...
    {
        var modelsInScene = new List< string >();
    ...
    {
        return AssetDatabase.FindAssets( name, new[] { $"{relativePathPrefabs}" } ).Any( guid => AssetDatabase.GUIDToAssetPath( guid ).EndsWith( name + ".prefab" ) );
    }
